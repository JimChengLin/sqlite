...
func Xsqlite3BtreeSetMmapLimit(tls *libc.TLS, p uintptr, szMmap Sqlite3_int64) (r int32) {
	return storageEngine().(StorageEngineBtreeSetMmapLimit).BtreeSetMmapLimit(btreeContext(tls), btreeHandle(tls, p), int64(szMmap))
}
...
func Xsqlite3BtreeIntegrityCheck(tls *libc.TLS, db uintptr, p uintptr, aRoot uintptr, nRoot int32, mxErr int32, pnErr uintptr, pzOut uintptr) (r int32) {
	return storageEngine().(StorageEngineBtreeIntegrityCheckFreebsd386).BtreeIntegrityCheckFreebsd386(btreeContext(tls), sqliteHandle(tls, db), btreeHandle(tls, p), btreeMemoryHandle(tls, aRoot), nRoot, mxErr, btreeMemoryHandle(tls, pnErr), btreeMemoryHandle(tls, pzOut))
}
...
func (nativeBtreeStorageEngine) BtreeSetMmapLimit(ctx BtreeContext, p BtreeHandle, szMmap int64) (r int32) {
	return XnativeSqlite3BtreeSetMmapLimit(ctx.tls, p.ptr, Sqlite3_int64(szMmap))
}
...
func (nativeBtreeStorageEngine) BtreeIntegrityCheckFreebsd386(ctx BtreeContext, db SQLiteHandle, p BtreeHandle, aRoot BtreeMemoryHandle, nRoot int32, mxErr int32, pnErr BtreeMemoryHandle, pzOut BtreeMemoryHandle) (r int32) {
	return XnativeSqlite3BtreeIntegrityCheck(ctx.tls, db.ptr, p.ptr, aRoot.ptr, nRoot, mxErr, pnErr.ptr, pzOut.ptr)
}
...
func (nativeBtreeStorageEngine) BtreeClearCache(ctx BtreeContext, p BtreeHandle) {
	XnativeSqlite3BtreeClearCache(ctx.tls, p.ptr)
}
