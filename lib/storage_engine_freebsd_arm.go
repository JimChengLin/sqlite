...
type storageEngine interface {
	...
	Xsqlite3BtreeSetMmapLimit(tls *libc.TLS, p uintptr, szMmap Sqlite3_int64) int32
	...
	Xsqlite3BtreeIntegrityCheck(tls *libc.TLS, db uintptr, p uintptr, aRoot uintptr, nRoot int32, mxErr int32, pnErr uintptr, pzOut uintptr) int32
	...
	Xsqlite3BtreeClearCache(tls *libc.TLS, p uintptr)
...
func Xsqlite3BtreeSetMmapLimit(tls *libc.TLS, p uintptr, szMmap Sqlite3_int64) int32 {
	return currentStorageEngine.Xsqlite3BtreeSetMmapLimit(tls, p, szMmap)
}
...
func Xsqlite3BtreeIntegrityCheck(tls *libc.TLS, db uintptr, p uintptr, aRoot uintptr, nRoot int32, mxErr int32, pnErr uintptr, pzOut uintptr) int32 {
	return currentStorageEngine.Xsqlite3BtreeIntegrityCheck(tls, db, p, aRoot, nRoot, mxErr, pnErr, pzOut)
}
...
func Xsqlite3BtreeClearCache(tls *libc.TLS, p uintptr) {
	currentStorageEngine.Xsqlite3BtreeClearCache(tls, p)
}
...
func (nativeBtreeStorageEngine) Xsqlite3BtreeSetMmapLimit(tls *libc.TLS, p uintptr, szMmap Sqlite3_int64) int32 {
	return XnativeSqlite3BtreeSetMmapLimit(tls, p, szMmap)
}
...
func (nativeBtreeStorageEngine) Xsqlite3BtreeIntegrityCheck(tls *libc.TLS, db uintptr, p uintptr, aRoot uintptr, nRoot int32, mxErr int32, pnErr uintptr, pzOut uintptr) int32 {
	return XnativeSqlite3BtreeIntegrityCheck(tls, db, p, aRoot, nRoot, mxErr, pnErr, pzOut)
}
...
func (nativeBtreeStorageEngine) Xsqlite3BtreeClearCache(tls *libc.TLS, p uintptr) {
	XnativeSqlite3BtreeClearCache(tls, p)
}
